...
const HeroSection = () => {
	...
	return (
		<section
			className="relative bg-linear-to-br from-blue-50 to-blue-100 overflow-hidden"
			aria-label="Landing hero section"
		>
			<div className="max-w-[1440px] mx-auto px-6 pt-20 pb-32 text-center md:pt-32 md:pb-48 relative z-10">
				{/* Decorative circle */}
				<div
					className="absolute top-24 left-12 w-40 h-40 bg-blue-200 rounded-full blur-3xl opacity-40 animate-pulse"
					aria-hidden="true"
				></div>
